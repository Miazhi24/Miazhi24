...
1. **[ChessChums](https://github.com/Miazhi24/ChessChums)** - A 2 player chess game programed without an engine in order to demonstrate the capabilies of Python. a collaborative project with my friend [Eesa](https://github.com/ees4ykg)
